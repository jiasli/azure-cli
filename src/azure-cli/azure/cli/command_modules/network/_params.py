...
def load_arguments(self, _):
    ...
    with self.argument_context('network vnet peering') as c:
        ...
        c.argument('remote_virtual_network', options_list=['--remote-vnet', c.deprecate(target='--remote-vnet-id', hide=True)], help='Resource ID or name of the remote VNet.')
    ...
    for scope in ['network vnet subnet list', 'network vnet peering list']:
        with self.argument_context(scope) as c:
            c.argument('ids', deprecate_info=c.deprecate(hide=True))
            c.argument('virtual_network_name', id_part=None)
