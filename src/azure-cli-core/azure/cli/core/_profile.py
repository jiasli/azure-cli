...
class Profile:
    ...
    def login(self,
              ...
              interactive_account_selection=False,
              **kwargs):
        """
        ...
        self._set_subscriptions(consolidated, interactive_account_selection=interactive_account_selection)
    ...
    def _set_subscriptions(self, new_subscriptions, merge=True, secondary_key_name=None,
                           interactive_account_selection=None):
